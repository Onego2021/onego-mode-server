...
from onego_recognizer.utils import CTCLabelConverter, AttnLabelConverter
from onego_recognizer.dataset import RawDataset, AlignCollate
from onego_recognizer.model import Model


device = torch.device("cuda" if torch.cuda.is_available() else "cpu")


class onego_recognizer:
    def __init__(
        self,
        image_folder = "/home/kobot-10/Project/model-server/input/manuscript_contour/",
        saved_model = "/home/kobot-10/Project/model-server/onego_recognizer/korOCR.pth",
        Transformation = "TPS",
...
def start_model():
    ...
    parser.add_argument('--image_folder', default="/home/kobot-10/Project/onego-modelserver/input/manuscript_contour/", help='path to image_folder which contains text images')
    parser.add_argument('--workers', type=int, help='number of data loading workers', default=4)
    parser.add_argument('--batch_size', type=int, default=192, help='input batch size')
    parser.add_argument('--saved_model', default="/home/kobot-10/Project/onego-modelserver/onego_recognizer/korOCR.pth", help="path to saved_model to evaluation")
    """ Data processing """
    ...
    '''
    predict_onego = onego_recognizer()

    return predict_onego.recognize()
